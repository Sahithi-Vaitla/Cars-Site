...
const Filters = ({
  ...
  const handleResetFilters = () => {
    ...
    onFilterChange('selectedPriceRange', '');
    onFilterChange('selectedTransmission', '');
    onFilterChange('selectedFuelType', '');
    onFilterChange('selectedPassengerCapacity', '');
  };
    ...
    <aside className="light-box">
      <div>
        ...
        <div className="filter-group">
          ...
          <select
            value={selectedYear}
            onChange={(event) => handleInputChange('selectedYear', event)}
          >
        ...
        <div className="filter-group">
          ...
          <select
            value={selectedBrand}
            onChange={(event) => handleInputChange('selectedBrand', event)}
          >
        ...
        <div className="filter-group">
          ...
          <select
            value={selectedModel}
            onChange={(event) => handleInputChange('selectedModel', event)}
          >
        ...
        <div className="filter-group">
          ...
          <select
            ...
            onChange={(event) => handleInputChange('selectedPriceRange', event)}
          >
        ...
        <div className="filter-group">
          ...
          <select
            ...
            onChange={(event) => handleInputChange('selectedFuelType', event)}
